Ext.define('Bling.controller.wms.MemberEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'member-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'member-editor tally-article-grid': {
            ...
            'member-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'member-editor #executeBtn': {
                click: this.execute
            }
        })
    },
