Ext.define('Bling.controller.wms.SellOrderEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'sell-order-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'sell-order-editor tally-article-grid': {
            ...
            'sell-order-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'sell-order-editor #executeBtn': {
                click: this.execute
            }
        })
    },
