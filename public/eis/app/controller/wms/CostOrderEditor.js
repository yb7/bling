Ext.define('Bling.controller.wms.CostOrderEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'cost-order-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'cost-order-editor tally-article-grid': {
            ...
            'cost-order-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'cost-order-editor #executeBtn': {
                click: this.execute
            }
        })
    },
    ...
    getEditor: function(cmp) {
        return cmp.up('cost-order-editor');
    }
