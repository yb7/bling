Ext.define('Bling.controller.wms.RegionalAllocationEditor', {
    ...
    init: function() {
        ...
        this.control({
            ...
            'regional-allocation-editor tally-article-grid': {
            ...
            'regional-allocation-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'regional-allocation-editor #executeBtn': {
                click: this.execute
            }
        })
    },
    ...
    openAddArticlesWin: function(cmp) {
        ...
        win.on('add-articles', function(array) {
            Ext.Ajax.request({
                url: '/eis/wms/regional-allocations/' + orderId + '/articles',
                method:'POST',
                jsonData:array,
    ...
    getEditor: function(cmp) {
        return cmp.up('regional-allocation-editor');
    },
    execute: function(btn) {
        var me = this;
        var id = this.getOrderId(btn);
        var executeUrl = '/eis/wms/regional-allocations/' + id + '/execute';
