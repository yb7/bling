Ext.define('Bling.controller.wms.FixOrderEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'fix-order-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'fix-order-editor tally-article-grid': {
            ...
            'fix-order-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'fix-order-editor #executeBtn': {
                click: this.execute
            }
        })
    },
