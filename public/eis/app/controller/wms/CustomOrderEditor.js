Ext.define('Bling.controller.wms.CustomOrderEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'custom-order-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'custom-order-editor tally-article-grid': {
            ...
            'custom-order-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'custom-order-editor #executeBtn': {
                click: this.execute
            }
        })
    },
