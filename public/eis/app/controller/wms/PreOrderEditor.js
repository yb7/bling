Ext.define('Bling.controller.wms.PreOrderEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'pre-order-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'pre-order-editor tally-article-grid': {
            ...
            'pre-order-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'pre-order-editor #executeBtn': {
                click: this.execute
            }
        })
    },
