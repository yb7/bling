Ext.define('Bling.controller.wms.CounterOrderEditor', {
    ...
    init: function() {
        var me = this;
        this.control({
            'counter-order-editor #uploadFileBtn': {
                click: this.uploadFile
            },
            'counter-order-editor tally-article-grid': {
            ...
            'counter-order-editor #deleteBtn': {
                click: this.deleteArticle
            },
            'counter-order-editor #executeBtn': {
                click: this.execute
            }
        })
    },
    ...
    getEditor: function(cmp) {
        return cmp.up('sell-order-editor');
    }
